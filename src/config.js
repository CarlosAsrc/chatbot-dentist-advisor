...
const config = {
    ...
    initialMessages: [
        createChatBotMessage(`Olá, aqui é a Estrela, assistente virtual especialista em Princípios do Preparo Radicular, vou ajuda-lo(a) a planejar cuidadosamente seus tratamentos endodônticos, evitando que você seja surpreendido durante a execução do preparo do canal.`, {}),
